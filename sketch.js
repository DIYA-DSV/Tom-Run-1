    ...
    function spawnWater1(){
      ...
      function spawnMud(){
        ...
        if(frameCount===420 || frameCount%900===0){
         1=createSprite(400,water.y-20,20,20);
         2=createSprite(0,water.y+20,20,20);
         3=createSprite(450,water.y-20,20,20);
         4=createSprite(-40,water.y+20,20,20);
  
        Rock1.shapeColor="brown";
        Rock1.velocityX=-1;
        Rock1.velocityY=1.5;
  
        Rock2.shapeColor="brown";
        Rock2.velocityX=1;
        Rock2.velocityY=1.5;
  
        Rock3.shapeColor="brown";
        Rock3.velocityX=-1;
        Rock3.velocityY=1.5;
  
        Rock4.shapeColor="brown";
        Rock4.velocityX=1;
        Rock4.velocityY=1.5;
